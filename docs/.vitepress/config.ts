...
const sidebar: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Spoolman and BambuBuddy', link: '/guide/integrations' },
      { text: 'Exports and cost reports', link: '/guide/exports' },
      { text: 'Series and repeat orders', link: '/guide/series' },
      { text: 'Spool inventory', link: '/guide/spools' },
