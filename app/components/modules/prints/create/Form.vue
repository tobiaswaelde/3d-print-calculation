        ...
        <template #hotends>
          <div class="space-y-4">
            ...
            <div
              ...
              :key="index"
              class="grid items-end gap-3 rounded-lg border border-default p-3 md:grid-cols-[1fr_8rem_8rem_auto]"
            >
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div
                ...
                :key="index"
                class="grid items-end gap-3 rounded-lg border border-default p-3 md:grid-cols-[1fr_12rem_auto]"
              >
